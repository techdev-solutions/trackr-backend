...
public enum FederalState {
    ...
    RHEINLAND_PFALZ("Rheinland-Pfalz"), SAARLAND("Saarland"), SACHSEN("Sachsen"), SACHSEN_ANHALT("Sachsen-Anhalt"), SCHLESWIG_HOLSTEINT("Schleswig-Holstein"), THUERINGEN("Thüringen");
